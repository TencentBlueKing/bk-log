# Generated by Django 3.2.5 on 2022-04-20 12:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name="计算平台结果表id"),
        ),
        migrations.AddField(
            model_name="collectorconfig",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[("transfer", "transfer"), ("bkbase", "bkbase")],
                default="transfer",
                max_length=32,
                verbose_name="数据处理引擎",
            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_enabled_display_collector", models.BooleanField(default=False, verbose_name="采集项是否对用户可见")),
                ...
                ("etl_config", models.CharField(default=None, max_length=32, null=True, verbose_name="清洗配置")),
                ("etl_template", models.JSONField(null=True, verbose_name="清洗配置模板")),
            ...
            options={
                ...
                "ordering": ("-updated_at",),
                "unique_together": {("collector_plugin_name_en", "bk_biz_id"), ("collector_plugin_name", "bk_biz_id")},
            },
        ),
    ]
