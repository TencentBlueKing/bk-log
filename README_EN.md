...
Please use [releases](https://github.com/TencentBlueKing/bk-log/releases) instead of the `master` branch in order to get stable binaries.
...
- Please read [Contributing](CONTRIBUTING_EN.md) for the branch management, issue and pr specifications of bk-log.
...
## License
BK-LOG is based on the MIT license. Please refer to [LICENCE](LICENSE.txt) for details.