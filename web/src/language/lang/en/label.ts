export default {
  ...
  "研发项目": "Research and development projects",
  ...
  "本业务可见": "Visible to Business",
  "多空间选择": "Multiple space selection",
  "字符集": "Character set",
  "HDFS地址": "HDFS address",
  "调试": "Debug",
  "表头显示别名": "Header Alias",
  ...
  "当前空间可见": "Visible to Current Space",
  ...
  "按照空间属性选择": "Choose according to space attributes",
  "选择采集项/采集插件": "Select collection / plug-in",
  "执行bk_biz_id": "Execute bk_biz_id"
}